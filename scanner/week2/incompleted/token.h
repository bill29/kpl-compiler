...
} TokenType; // khai báo các loại mã token.
...
typedef struct {
  ...
  TokenType tokenType;
  int value;
} Token; //khai báo một token .
// - một sâu lưu lại toàn bộ
// - lưu lại dòng , lưu lại cột
// - loại token đang sử dụng
// value 

TokenType checkKeyword(char *string); //tạo ra một cái để kiểm tra xem nó là cái nào .
Token* makeToken(TokenType tokenType, int lineNo, int colNo); // tạo ra một token theo cấu định 
//với những khai báo loại , dòng , cột.
#endif
